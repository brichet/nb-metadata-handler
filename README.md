...
```bash
pip install nb_metadata_handler
```
...
```bash
pip uninstall nb_metadata_handler
```
...
# Change directory to the nb_metadata_handler directory
...
folder is located. Then you can remove the symlink named `nb-metadata-handler` within that folder.
